...
public class Predator {
	...
	public double[][] stateValueFunction(State environment)
	{
		...
		for(Point key : hashedMoves.keySet() )
		{
			...
			grid = add(grid, times(tempGrid, hashedMoves.get(key))); // add tempGrid to grid, where tempGrid is weighted by the transition prob.
		}
		return grid;
